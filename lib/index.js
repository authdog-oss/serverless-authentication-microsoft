...
var MicrosoftProvider = function (_Provider) {
  ...
  _createClass(MicrosoftProvider, [{
    ...
    value: function callback(event, _callback) {
      ...
      _get(Object.getPrototypeOf(MicrosoftProvider.prototype), 'callback', this).call(this, event, options, { grant_type: 'authorization_code' }, _callback);
    }
  }]);
...
//
// function signin({id, redirect_uri}, {scope = 'wl.basic', state}, callback) {
//   let params = {
//     client_id: id,
//     redirect_uri,
//     scope,
